...
# In this file you'll explore using transcribe with llm summarizer

# === CONFIG ===
REGION = "us-west-2"
# CHANGE THIS TO MATCH BUCKET NAME YOU CREATED
BUCKET = "transcribe-demo-bucket" 
# CHANGE THIS TO MATCH NAME OF YOUR VIDEO
OBJECT_KEY = "transcribe.mp4" 
...
def main():
   ...
   # === STEP 3: Read Transcript from S3 [WITHOUT SPEAKER DIARIZATION] ===
   if status == "COMPLETED":
       obj = s3.get_object(Bucket=BUCKET, Key=TRANSCRIPT_JSON_KEY)
       data = json.loads(obj["Body"].read())
       transcript = data["results"]["transcripts"][0]["transcript"]

       # OPTION 1 - PRINT PREVIEW OF TRANSCRIPT
       # print("\n[<>] Transcript Preview:\n", transcript[:1000], "...\n")

       # OPTION 2 - PRINT FULL TRANSCRIPT
       print("\n\n\n[<>] Transcript:\n", transcript, "...\n\n\n")


       # === STEP 4: Summarize via Bedrock ===
       # EDIT PROMPT HERE BASED ON VIDEO TYPE USED IN TRANSCRIBE
       prompt = (
           "\n\nHuman: Summarize the following transcript, what is being said in the video "
